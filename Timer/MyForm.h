...
namespace Timer1 {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ ывываToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ывываToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(209, 182);
			...
			// 
			this->обновленияToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
				this->проверкаОбновленийToolStripMenuItem,
					this->ывываToolStripMenuItem
			});
			...
			// 
			// ывываToolStripMenuItem
			// 
			this->ывываToolStripMenuItem->Name = L"ывываToolStripMenuItem";
			this->ывываToolStripMenuItem->Size = System::Drawing::Size(199, 22);
			this->ывываToolStripMenuItem->Text = L"Ывыва";
			// 
			// MyForm
			// 
